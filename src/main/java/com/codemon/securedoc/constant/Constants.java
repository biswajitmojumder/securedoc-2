package com.codemon.securedoc.constant;

/*
    * This class will hold all the constants of the permission
 */
public class Constants {
    ...
    public static final String ADMIN_AUTHORITIES = "user:create, user:read, user:update, document:create, " +
